...
> git checkout -d <name> - создание ветки и переход к ней
...
>git config --global user.email"" - инициализация почты в git

>git config --global user.name"" - инициализация в git
